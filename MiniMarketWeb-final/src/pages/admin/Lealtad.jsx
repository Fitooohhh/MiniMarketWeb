...
import { Plus, Edit, Trash2, Star, Users, Gift, TrendingUp, Settings } from 'lucide-react'
...
export default function Lealtad() {
  ...
  const handleConfigurarPrograma = () => {
    navigate('/admin/lealtad/configurar')
  }

  const handleCrearNivel = () => {
    navigate('/admin/lealtad/nivel/nuevo')
  }

  const handleCrearRecompensa = () => {
    navigate('/admin/lealtad/recompensa/nueva')
  }
    ...
    <div className="p-6">
      <div className="flex justify-between items-center mb-6">
        <div>
          ...
          <p className="text-gray-600 mt-1">Gestiona el programa de lealtad y recompensas</p>
        </div>
      ...
      {activeTab === 'programa' && (
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
          <h3 className="text-lg font-medium text-gray-900 mb-4">Configuración del Programa</h3>
          ...
          {niveles.map((nivel) => (
            <div key={nivel.id_nivel} className="bg-white rounded-lg shadow-sm border border-gray-200 p-4">
              <div className="flex justify-between items-start">
                ...
                <div className="flex gap-2">
                  <button
                    onClick={() => navigate(`/admin/lealtad/nivel/${nivel.id_nivel}/editar`)}
          ...
          {recompensas.map((recompensa) => (
            <div key={recompensa.id_recompensa} className="bg-white rounded-lg shadow-sm border border-gray-200 p-4">
              ...
              <div className="flex gap-2 mt-4 pt-4 border-t">
                <button
                  onClick={() => navigate(`/admin/lealtad/recompensa/${recompensa.id_recompensa}/editar`)}
